import { createCampaign as createInstantlyCampaign, activateCampaign, addLeadsToCampaign, } from '../clients/instantly';
import { generateEmailSequence } from '../ai/generateEmailCopy';
import { createCampaign as createCampaignRecord, createCampaignEmails, getCampaign, getCampaignEmails, getSupabaseClient, incrementCampaignLeadCount, markLeadRouted, updateCampaign, } from '../db/autogtmDbCalls';
